...
const { createRouteSchema, listRoutesQuerySchema, updateRouteSchema } = require('../validators/routeSchemas');
...
router.put('/:id', validate(updateRouteSchema), asyncHandler(routeController.updateRoute));
